    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings for the Google Form trigger here. This trigger
            allows you to start the workflow when a Google Form is submitted.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
              ...
              <li>
                {" "}
                Copy and paste the following code, replacing WEBHOOK_URL with
                the URL above
              </li>
          ...
          <div className="rounded-lg bg-muted p-4 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              This script captures form responses and sends them to the
